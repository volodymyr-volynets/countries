...
class PostgreSQL extends \Object\Function2 {
	...
	public $db_link_flag;
	public $schema;
	public $name = 'calculate_distance_in_units';
	public $backend = 'PostgreSQL';
	public $header = 'calculate_distance_in_units(a_lat numeric, a_lon numeric, b_lat numeric, b_lon numeric, miles int)';
	public $sql_version = '1.0.1';
	public $definition = 'CREATE OR REPLACE FUNCTION public.calculate_distance_in_units(a_lat numeric, a_lon numeric, b_lat numeric, b_lon numeric, miles int)
RETURNS numeric
    LANGUAGE \'plpgsql\'
    COST 100
    IMMUTABLE STRICT
